    ...
    <div class="content bg-light">
            ...
            <div class="inner-content mt-2 p-3">
              ...
              <div class="" id="display">
                ...
                <div class="chemicals">
                    <div class="header">
                        <h6 class="mt-2">Apparatus</h6>
                        <a href="./apparatus.php" class="btn"><i class="fas fa-arrow-circle-right    "></i></a>

                    </div>

                    <!-- category buttons -->
                    <div class="cat-btns">
                        <button id="all" class='btn cat-btn2 btn-outline-success mr-2 mt-2 mb-2 active' style='font-size: 12px;'>All Apparatus</button>
                        <?php
                            // $cat_btns = $conn->query("select category from apparatus group by category");
                    ...
                    <div class="all mt-3">
                        ...
                        <div class="home-cards">
                            <?php
                                $select = $conn->query("select * from apparatus");
                                while($row = $select->fetch_assoc())
                                {
                                    ?>
                                    <!-- <div class=" mt-3"> -->
                                            <div class="card-deck about-apparatus mr-2" id="<?= $row['id'] ?>" style="cursor:pointer;">
